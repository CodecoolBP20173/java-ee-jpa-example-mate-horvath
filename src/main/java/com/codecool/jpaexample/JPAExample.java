...
public class JPAExample {
    ...
    private static void populateDb(EntityManager em) {
        ...
        Student student = new Student("Ödön", "odon@tokodon.hu", birthDate1, address, "06301111111");
        ...
        Student student2 = new Student("Aladár", "ktyfl@gmail.com", birthDate2, address2, "06302222222");
